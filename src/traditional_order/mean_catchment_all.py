...
for csv_file in csv_files:
    ...
    grouped = df.groupby(['MAIN_RIV','ORD_STRA']).agg({'CATCH_SKM':'mean'}).reset_index()
...
# 将结果保存到 excel 文件
result_df.to_excel('/data_seagate/zhaocs/data/hydroatlas/data_class/mean_catchment_all.xlsx', index=False)